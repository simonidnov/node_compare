...
new idkids_jssdk({secret:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZWNyZXQiOiI1YTMwZGViZmYzNjViMzBhZmQ3ODY4OWMiLCJpYXQiOjE1MTMxNTgxODV9.8e9JhLtcpzf8hO2CguRuUINBpLWOOClx_-3GfFoVqcM",callback_url:window.location.origin+"/redirect/",authorisation:{email:!0}},function(a,c){console.log("this.sdk ::: ",a,c)});var a=this;this.sdk.init($.proxy(function(b){this.sdk.isLogged($.proxy(function(b){"logged"===b.status&&this.sdk.api.get("/me",{},$.proxy(function(b){0==$('[data-userid="'+b.datas._id+'"]').length&&
($(".account_list").prepend('<a href="/auth/login/email/'+b.datas.email+'" data-action="page_reload"><li data-userid="'+b.datas._id+'"><div class="avatar" style="background-image:url('+b.datas.avatar+')"></div><div class="option_infos"><div class="label">'+b.datas.pseudo+'</div><div class="email">'+b.datas.email+'</div><div class="status">connected</div></div></li></a>'),a.resize());this.set_listeners()},this))},this))},this));index.sdk=login.sdk},navigate:function(){var a=login.parse_url(window.location.pathname);
if("undefined"!==typeof a.auth)switch(a.auth){case "login":$("#account_selection").addClass("displaynone").removeClass("displayblock");$("#account_forms").removeClass("displaynone").addClass("displayblock");$("#login_form").css("display","block");$("#subscribe_form").css("display","none");$("#lost_form").css("display","none");$('[data-tab="login_form"]').addClass("selected");$('[data-tab="subscribe_form"]').removeClass("selected");$("#email").focus();"undefined"!==typeof a.email?($("#email").val(a.email),
login.form.inputCheck($("#email"),!1)):($("#email").val(""),$("#password").val(""));login.form.checkInputs(!1);break;case "subscribe":$("#account_selection").addClass("displaynone").removeClass("displayblock");$("#account_forms").removeClass("displaynone").addClass("displayblock");$("#email").val("");$("#password").val("");$("#login_form").css("display","none");$("#subscribe_form").css("display","block");$("#lost_form").css("display","none");$('[data-tab="subscribe_form"]').addClass("selected");$('[data-tab="login_form"]').removeClass("selected");
