...
module.exports.create=function(b,a,c){a=b.body;delete a.options;delete a._id;delete a.user;new_coupon=new Coupon(b.body);new_coupon.save(function(a,b){a?c({status:405,message:a}):c({status:200,datas:b})})};module.exports.useOne=function(b,a){Coupon.updateOne({_id:b._id},{$set:{is_valid:0,already_used:1,user_id:b.user_id,updated:Date.now()}},function(b,d){b?a({status:304,message:b}):a({status:200,datas:d})})};
module.exports.update=function(b,a,c){b.body.updated=Date.now();Coupon.updateOne({_id:b.body.coupon_id},{$set:b.body},function(a,b){a?c({status:304,message:a}):c({status:200,datas:b})})};module.exports.updateAmount=function(b,a,c){Coupon.updateMany({offer:"chansonspersonnalisees"},{$set:{amount:499}}).exec(function(a,b){c({status:200,datas:b})})};
