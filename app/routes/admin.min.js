...
function(a,b,d){Coupon_controller.getOffers(a,b,function(c){var d=c.datas;Coupon_controller.get(a,b,function(c){console.log("coupons ",c);b.render("admin/coupons",{title:"Admin Coupons",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,coupons:c.datas,page:"show_offer",offers:d,js:["/public/javascripts/admin/coupons.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/coupons.css",
"/public/stylesheets/components/formular.css"]});b.end()})})}).get("/baskets",function(a,b,d){Basket_controller.get(a,b,function(c){baskets=c.datas;b.render("admin/baskets",{title:"Admin Baskets",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"baskets",baskets:baskets,js:["/public/javascripts/admin/baskets.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/baskets.css",
"/public/stylesheets/components/formular.css"]});b.end()})});module.exports=admin;
