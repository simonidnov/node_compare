...
module.exports.get=function(a,e,c){console.log("GET USER PRODUCTS ?");var b={};"undefined"!==typeof a.session.Auth?b={user_id:a.session.Auth._id}:"undefined"!==typeof a.query.user_id?b={user_id:datas.user_id}:"undefined"!==typeof a.query.options&&(b={user_id:a.query.options.user_id});if("undefined"===typeof b.user_id)return c({status:401,datas:{message:"UNAUTHORISED_NEED_USER"}}),!1;"undefined"!==typeof a.query.product_id&&(b.product_id=a.query.product_id);a.user_id=b.user_id;this.checkOrders(a,e,
function(a){Userproducts.find(b,function(a,b){a?c({status:405,datas:a}):c({status:200,datas:b});return!1}).sort({created:-1})})};module.exports.allreadyBuy=function(a,e,c){console.log("allreadyBuy :::::: ",a," :::::: req.session.Auth._id before ::::::: product id  :::::: ",e);Userproducts.findOne({user_id:a,product_id:e},function(a,d){a?c({status:404,message:"NEVER_BUY"}):null===d?c({status:404,message:"NEVER_BUY",datas:d}):c({status:200,message:"ALREADY_BUY",datas:d})})};
module.exports.checkOrders=function(a,e,c){var b=this;Orders_model.get(a,e,function(c){if(200===c.status)for(var d=0;d<c.datas.length;d++)if("undefined"!==typeof c.datas[d].basketdatas)for(var h=0;h<c.datas[d].basketdatas.products.length;h++)"undefined"!==typeof c.datas[d].refund?"charge_already_refunded"!==c.datas[d].refund.code&&"succeeded"!==typeof c.datas[d].refund.status||b.remove({user_id:a.user_id,product_id:c.datas[d].basketdatas.products[h].product_id},e,function(a){}):b.create({user_id:a.user_id,
product_id:c.datas[d].basketdatas.products[h].product_id},e,function(a){})});c({status:200,message:"CHECKING"})};
