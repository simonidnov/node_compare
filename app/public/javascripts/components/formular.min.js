...
f.attr("data-target")).val(a.path)}})})}});$(b).find("[data-action], [data-formaction]").off("click").on("click",function(d){d.preventDefault();d=$(this).attr("data-action");switch(d){case "switch_tab":a.callback({status:"hitted",action:d});break;case "submit":"undefined"!==typeof $(b).find("form").attr("action")&&"undefined"!==typeof $(b).find("form").attr("method")?(e({status:"hitted",action:"submit_form",form:$(b).find("form")}),e({status:"hitted",action:"submit",form:$(b).find("form")})):e({status:"hitted",
action:"submit"});break;default:a.callback({status:"hitted",action:d})}return!1});$(b).find("[data-formaction]").off("click").on("click",function(b){b.preventDefault();b=$(this).attr("data-formaction");switch(b){case "switch_tab":a.callback({status:"hitted",action:b});break;case "submit":e({status:"hitted",action:"submit_form",form:$("#"+$(this).attr("data-formid"))});break;default:a.callback({status:"hitted",action:b})}return!1});$(b).find(".material_input input").off("focus").on("focus",function(){$(this).parent().addClass("focused");
a.callback({status:"focus",value:$(this)});if("date"===$(this).attr("type")){var b=navigator.userAgent||navigator.vendor||window.opera;if(/windows phone/i.test(b)||/android/i.test(b)||/iPad|iPhone|iPod/.test(b)&&!window.MSStream)return!1;new datepicker($(this),function(a){})}});a.check_min_max();$(b).find(".material_input input, .material_input textarea").off("keypress").on("keypress",function(){a.check_min_max()});$(b).find(".material_input input").off("blur").on("blur",function(){a.check_min_max();
a.inputCheck($(this),!0);$(this).parent().removeClass("focused");a.callback({status:"blur",value:$(this)})});$(b).find(".material_input input").off("input").on("input",function(){a.inputCheck($(this),!1)});$(b).find('input[type="checkbox"]').off("change").on("change",function(){a.inputCheck($(this));a.checkInputs(!1);a.callback({status:"checkbox",name:$(this).attr("name"),value:$(this).is(":checked")})});a.checkInputs(!1);$(b).find("[data-tab]").off("click").on("click",function(){var b=$(this).attr("data-tab");
$.each($(this).parent().find("[data-tab]"),function(a,d){$(this).attr("data-tab")===b?($("#"+$(this).attr("data-tab")).css("display","block"),$('[data-tab="'+$(this).attr("data-tab")+'"]').addClass("selected")):($("#"+$(this).attr("data-tab")).css("display","none"),$('[data-tab="'+$(this).attr("data-tab")+'"]').removeClass("selected"))});a.callback({status:"tab_change",value:$(this).attr("data-tab")})})};this.check_min_max=function(){$.each($(b).find(".minlength"),function(a,b){var c;if(0<$(this).find("input").length)b=
$(this).find("input"),c=b.val();else if(0<$(this).find("textarea").length)b=$(this).find("textarea"),c=b.val();else return!1;0===$(this).find(".number").length&&$(this).append('<span class="number"></span>');c.length+1>=parseInt(b.attr("minlength"))?$(this).find(".number").html('<span class="icon idkids-icon icon-check"></span>'):$(this).find(".number").html(c.length+"/"+b.attr("minlength"))})};this.checkInputs=function(a){var d=this;$.each($(b).find(".material_input input"),function(b,f){d.inputCheck($(this),
a)})};this.inputCheck=function(a,b){if("checkbox"===a.attr("type")){this.validform();if(a.is(":checked"))return $('[data-checkboxrelative="'+a.attr("id")+'"]').css("display","block"),!0;$('[data-checkboxrelative="'+a.attr("id")+'"]').css("display","none");return!1}if(""==a.val())a.parent().removeClass("invalid"),a.parent().removeClass("valid"),a.parent().removeClass("notempty"),a.parent().find(".input_error").remove();else{switch(a.attr("type")){case "email":this.validateEmail(a.val())?(a.parent().addClass("valid"),
a.parent().removeClass("invalid"),a.parent().find(".input_error").remove()):(a.parent().addClass("invalid"),a.parent().removeClass("valid"),"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>"));this.validform();return;case "date":a.parent().addClass("valid");this.validform();return;case "radio":this.validform();break;case "checkbox":this.validform()}a.parent().addClass("notempty");
if("undefined"!==typeof a.attr("data-regex")){if("same"===a.attr("data-regex"))return a.val()===$("#"+a.attr("data-target")).val()?(a.parent().addClass("valid"),a.parent().removeClass("invalid"),a.parent().find(".input_error").remove()):(a.parent().addClass("invalid"),a.parent().removeClass("valid"),"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>")),!1;(new RegExp(a.attr("data-regex").toString())).test(a.val())?
(a.parent().removeClass("invalid"),a.parent().addClass("valid"),0<a.parent().find(".input_error").length&&a.parent().find(".input_error").remove(),0<$('[data-checkinput="'+a.attr("id")+'"]').length&&$('[data-checkinput="'+a.attr("id")+'"] .check').addClass("checked")):("undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>"),a.parent().addClass("invalid"),a.parent().removeClass("valid"));
0<$('[data-checkinput="'+a.attr("id")+'"]').length&&($('[data-checkinput="'+a.attr("id")+'"] .check').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_hash').length&&-1!==a.val().indexOf("#")?$('[data-checkinput="'+a.attr("id")+'"] .check_hash').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_hash').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').length&&-1!==a.val().indexOf("@")?$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').addClass("checked"):
$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_dot').length&&-1!==a.val().indexOf(".")?$('[data-checkinput="'+a.attr("id")+'"] .check_dot').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_dot').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_length').length&&a.val().length>=a.attr("minlength")?$('[data-checkinput="'+a.attr("id")+'"] .check_length').addClass("checked"):$('[data-checkinput="'+
a.attr("id")+'"] .check_length').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_capital').length&&(RegExp("[A-Z]+","g").test(a.val())?$('[data-checkinput="'+a.attr("id")+'"] .check_capital').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_capital').removeClass("checked")),0<$('[data-checkinput="'+a.attr("id")+'"] .check_number').length&&(RegExp("[0-9]+","g").test(a.val())?$('[data-checkinput="'+a.attr("id")+'"] .check_number').addClass("checked"):$('[data-checkinput="'+
a.attr("id")+'"] .check_number').removeClass("checked")))}else if("undefined"!==typeof a.attr("minlength")){var c=a.attr("minlength");a.val().length<c?(a.parent().addClass("invalid"),a.parent().removeClass("valid")):(a.parent().addClass("valid"),a.parent().removeClass("invalid"))}else a.parent().addClass("valid"),a.parent().removeClass("invalid");this.validform()}};this.validform=function(a){$.each($(this.target).find("form"),function(a,b){var c=!0,g=$(this);$.each(g.find("input"),function(a,b){$(this).attr("required")&&
("checkbox"===$(this).attr("type")?$(this).is(":checked")?$('[data-checkboxrelative="'+$(this).attr("id")+'"]').css("display","block"):($('[data-checkboxrelative="'+$(this).attr("id")+'"]').css("display","none"),c=!1):"radio"!==$(this).attr("type")&&!$(this).parent().hasClass("valid")&&$(this).attr("required")&&(c=!1))});c?(g.find('button[type="submit"], [data-action="submit"]').removeClass("btn-disabled"),e({form:g.attr("id"),status:"validated"})):(g.find('button[type="submit"], [data-action="submit"]').addClass("btn-disabled"),
