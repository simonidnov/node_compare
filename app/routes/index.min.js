...
router.use(function(b,a,c){a.setHeader("Access-Control-Allow-Origin","*");a.setHeader("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept");a.setHeader("Access-Control-Allow-Methods","GET, PUT, POST, DELETE");a=(b.headers["x-forwarded-proto"]||"").toLowerCase();console.log("HAS HTTPS ",a);console.log("req.get('host') ",b.get("host"));console.log("req.get('origin') ",b.get("origin"));c()});
router.get("/",function(b,a,c){a.render("offline",{title:"IDKIDS.community WELCOME"});a.end()});
