...
js:["/public/javascripts/components/formular.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/ui.css","/public/stylesheets/components/formular.css"]});b.end()}).get("/users",function(a,b,d){require("../controllers/auth_controller").get(a,b,function(c){b.render("admin/users",{title:"Admin Users",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"users",users:c.users,js:["/public/javascripts/admin/users.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js",
"/public/javascripts/farnientejs/farnientejs.min.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/ui.css","/public/stylesheets/admin/users.css","/public/stylesheets/components/formular.css"]});b.end()})}).get("/notifications",function(a,b,d){b.render("admin/notifications",{title:"Admin Notifications",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"notifications",js:["/public/javascripts/admin/notifications.js","/public/javascripts/components/formular.js",
...
css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/settings.css","/node_modules/cropperjs/dist/cropper.min.css","/public/stylesheets/components/formular.css"]});b.end()}).get("/translations",function(a,b,d){b.render("admin/translations",{title:"Admin translations",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"translations",js:["/public/javascripts/admin/translations.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],
...
"/public/stylesheets/components/formular.css"]});b.end()})}).get("/pages/:page/:_id",function(a,b,d){var c=null;Pages_controller.get(a,b,function(d){c=d.datas;edit_page=_.where(JSON.parse(JSON.stringify(c)),{_id:a.params._id})[0];b.render("admin/pages",{title:"Admin Pages",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:a.params.page,pages:c,page_id:a.params._id,edit_page:edit_page,_:_,js:"/public/javascripts/admin/pages.js /public/javascripts/components/pager/pager.js /node_modules/cropperjs/dist/cropper.min.js /public/javascripts/components/formular.js /public/javascripts/components/jquery-ui.min.js /node_modules/qrcode/build/qrcode.min.js".split(" "),
css:["/public/stylesheets/admin/admin.css","/node_modules/cropperjs/dist/cropper.min.css","/public/stylesheets/admin/pages.css","/public/stylesheets/components/formular.css","/public/stylesheets/components/pager/pager.css"]});b.end()})}).get("/products",function(a,b,d){Products_controller.get(a,b,function(c){products=c.datas;b.render("admin/products",{title:"Admin Products",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"products",products:products,js:["/public/javascripts/admin/products.js",
"/public/javascripts/components/formular.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/products.css","/public/stylesheets/components/formular.css"]});b.end()})}).get("/products/:page",function(a,b,d){Products_controller.get(a,b,function(c){products=c.datas;b.render("admin/products",{title:"Admin Products",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:a.params.page,products:products,js:["/public/javascripts/admin/products.js","/public/javascripts/components/formular.js",
"/node_modules/dropzone/dist/dropzone.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/products.css","/public/stylesheets/components/formular.css","/node_modules/dropzone/dist/dropzone.css"]});b.end()})}).get("/products/:page/:_id",function(a,b,d){Products_controller.get(a,b,function(c){products=c.datas;a.body._id=a.params._id;Products_controller.get({product_id:a.body._id},a,function(c){product_datas=c.datas[0];b.render("admin/products",{title:"Admin Products",user:a.session.Auth,
locale:language_helper.getlocale(a),lang:lang,page:a.params.page,products:products,edit_product:product_datas,js:["/public/javascripts/admin/products.js","/public/javascripts/components/formular.js","/node_modules/cropperjs/dist/cropper.min.js","/node_modules/dropzone/dist/dropzone.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/products.css","/node_modules/cropperjs/dist/cropper.min.css","/public/stylesheets/components/formular.css","/node_modules/dropzone/dist/dropzone.css"]});
b.end()})})}).get("/orders",function(a,b,d){Orders_controller.get(a,b,function(c){orders=c.datas;b.render("admin/orders",{title:"Admin Orders",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"orders",orders:orders,js:["/public/javascripts/admin/orders.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/orders.css","/public/stylesheets/components/formular.css"]});b.end()})}).get("/coupons",
function(a,b,d){Coupon_controller.getOffers(a,b,function(c){b.render("admin/coupons",{title:"Admin Coupons",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"coupons",offers:c.datas,js:["/public/javascripts/admin/baskets.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/baskets.css","/public/stylesheets/components/formular.css"]});b.end()})}).get("/coupons/new_offer",
function(a,b,d){Coupon_controller.getOffers(a,b,function(c){b.render("admin/coupons",{title:"Admin Coupons",user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"new_offer",offers:c.datas,js:["/public/javascripts/admin/coupons.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],css:["/public/stylesheets/admin/admin.css","/public/stylesheets/admin/coupons.css","/public/stylesheets/components/formular.css"]});b.end()})}).get("/coupons/show_offer/:offer",
