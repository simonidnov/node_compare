...
module.exports.create=function(b,a,c){a=b.body;delete a.options;delete a._id;delete a.user;new_coupon=new Coupon(b.body);new_coupon.save(function(a,b){a?c({status:405,message:a}):c({status:200,datas:b})})};module.exports.useOne=function(b,a){Coupon.updateOne({_id:b._id},{$set:{is_valid:!1,already_used:!0,user_id:b.user_id,updated:Date.now()}},function(b,d){b?a({status:304,message:b}):a({status:200,datas:d})})};
module.exports.update=function(b,a,c){b.body.updated=Date.now();Coupon.updateOne({_id:b.body.coupon_id},{$set:b.body},function(a,b){a?c({status:304,message:a}):c({status:200,datas:b})})};module.exports.updateAmount=function(b,a,c){Coupon.updateMany({},{$set:{amount:499}}).exec(function(a,b){c({status:200,datas:b})})};
module.exports["delete"]=function(b,a,c){a={};"undefined"!==typeof b.body.offer&&(a.offer=b.body.offer);"undefined"!==typeof b.body.coupon_id&&(a._id=b.body.coupon_id);"undefined"!==typeof b.body.code&&(a.code=b.body.code);Coupon.deleteMany(a,function(a,b){a?c({status:405,message:a}):c({status:200,pages:b})})};
module.exports.is_valid=function(b,a,c){Coupon.find({_id:a,code:b,is_valid:!0,already_used:!1},function(a,b){a?c({status:405,message:a}):1<=b.length?c({status:200,coupon:b[0]}):c({status:203,coupon:b})})};
