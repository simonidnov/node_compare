...
message:'Vous avez d\u00e9j\u00e0 achet\u00e9 ce produit, rendez-vous sur <a href="http://machanson.joyvox.fr/playlist">votre playlist</a> pour l\'\u00e9couter !',type:"modal",motion:{color:"coral",src:app.locals.settings.host+"/public/images/assets/basket.svg"},buttons:[{"class":"btn-warning centered",label:"MON COMPTE",href:app.locals.settings.host+"/account/orders",target:"_blank",value:"/account/orders"}]}},a)):d()})},function(a,c,d){Basket_controller.create(a.body,c,function(b){c.status(b.status).send(Auth_helper.addParams({status:b.status,
