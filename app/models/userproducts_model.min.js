...
module.exports.get=function(a,e,b){console.log(":::::::::::::::: ");console.log(":::::::::::::::: ");console.log(":::::::::::::::: ");console.log(":::::::::::::::: ");console.log("datas get products :::::::::::::::: ",a.query);console.log(":::::::::::::::: ");console.log(":::::::::::::::: ");console.log(":::::::::::::::: ");console.log(":::::::::::::::: ");var c={};"undefined"!==typeof a.session.Auth?c={user_id:a.session.Auth._id}:"undefined"!==typeof a.query.user_id?c={user_id:datas.user_id}:"undefined"!==
typeof a.query.options&&(c={user_id:a.query.options.user_id});if("undefined"===typeof c.user_id)return b({status:401,datas:{message:"UNAUTHORISED_NEED_USER"}}),!1;a.user_id=c.user_id;console.log("datas get products :::::::::::::::: ",a.query);this.checkOrders(a,e,function(a){Userproducts.find(c,function(a,c){a?b({status:405,datas:a}):b({status:200,datas:c});return!1}).sort({created:-1})})};
