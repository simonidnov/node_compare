...
$(this).find(".number").html(c.length+"/"+b.attr("minlength"))})};this.checkInputs=function(a){var d=this;$.each($(b).find(".material_input input, .material_input select, .material_input textarea"),function(b,f){d.inputCheck($(this),a)})};this.inputCheck=function(a,b){if("checkbox"===a.attr("type")){this.validform();if(a.is(":checked"))return $('[data-checkboxrelative="'+a.attr("id")+'"]').css("display","block"),!0;$('[data-checkboxrelative="'+a.attr("id")+'"]').css("display","none");return!1}if("SELECT"===
a.prop("tagName"))return console.log("????????? ",a.val()),console.log("????????? ",a.is(":required")),null===a.val()&&a.is(":required")?b&&a.is(":required")?(a.parent().addClass("invalid"),a.parent().removeClass("valid"),"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>")):(a.parent().removeClass("invalid"),a.parent().removeClass("valid"),a.parent().removeClass("notempty"),
a.parent().find(".input_error").remove()):(console.log("HERE ",a.val()),a.parent().removeClass("invalid"),a.parent().addClass("valid"),a.parent().addClass("notempty"),a.parent().find(".input_error").remove()),!1;if(""===a.val())b&&a.is(":required")?"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&(a.parent().addClass("invalid"),a.parent().removeClass("valid"),a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>")):(a.parent().removeClass("invalid"),
a.parent().removeClass("valid"),a.parent().removeClass("notempty"),a.parent().find(".input_error").remove());else{a.parent().addClass("notempty");switch(a.attr("type")){case "email":this.validateEmail(a.val())?(a.parent().addClass("valid"),a.parent().removeClass("invalid"),a.parent().find(".input_error").remove()):(a.parent().addClass("invalid"),a.parent().removeClass("valid"),"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+
a.attr("data-errormessage")+"</div>"));this.validform();return;case "text":a.parent().addClass("valid");a.parent().removeClass("invalid");a.parent().find(".input_error").remove();break;case "date":a.parent().addClass("valid");this.validform();return;case "radio":this.validform();break;case "checkbox":this.validform()}if("undefined"!==typeof a.attr("data-regex")){if("same"===a.attr("data-regex"))return a.val()===$("#"+a.attr("data-target")).val()?(a.parent().addClass("valid"),a.parent().removeClass("invalid"),
a.parent().find(".input_error").remove()):(a.parent().addClass("invalid"),a.parent().removeClass("valid"),"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>")),!1;(new RegExp(a.attr("data-regex").toString())).test(a.val())?(a.parent().removeClass("invalid"),a.parent().addClass("valid"),0<a.parent().find(".input_error").length&&a.parent().find(".input_error").remove(),0<$('[data-checkinput="'+
a.attr("id")+'"]').length&&$('[data-checkinput="'+a.attr("id")+'"] .check').addClass("checked")):("undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>"),a.parent().addClass("invalid"),a.parent().removeClass("valid"));0<$('[data-checkinput="'+a.attr("id")+'"]').length&&($('[data-checkinput="'+a.attr("id")+'"] .check').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+
'"] .check_hash').length&&-1!==a.val().indexOf("#")?$('[data-checkinput="'+a.attr("id")+'"] .check_hash').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_hash').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').length&&-1!==a.val().indexOf("@")?$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_dot').length&&
-1!==a.val().indexOf(".")?$('[data-checkinput="'+a.attr("id")+'"] .check_dot').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_dot').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_length').length&&a.val().length>=a.attr("minlength")?$('[data-checkinput="'+a.attr("id")+'"] .check_length').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_length').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_capital').length&&(RegExp("[A-Z]+",
"g").test(a.val())?$('[data-checkinput="'+a.attr("id")+'"] .check_capital').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_capital').removeClass("checked")),0<$('[data-checkinput="'+a.attr("id")+'"] .check_number').length&&(RegExp("[0-9]+","g").test(a.val())?$('[data-checkinput="'+a.attr("id")+'"] .check_number').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_number').removeClass("checked")))}if("undefined"!==typeof a.attr("minlength")){var c=a.attr("minlength");
a.val().length<c&&a.is(":required")?(a.parent().addClass("invalid"),a.parent().removeClass("valid"),b&&"undefined"!==typeof a.attr("data-errormessage")&&0==a.parent().find(".input_error").length&&b&&a.parent().append('<div class="input_error">'+a.attr("data-errormessage")+"</div>")):(a.parent().addClass("valid"),a.parent().removeClass("invalid"),a.parent().find(".input_error").remove())}else a.parent().addClass("valid"),a.parent().removeClass("invalid");this.validform()}};this.validform=function(a){$.each($(this.target).find("form"),
function(a,b){var c=!0,g=$(this);$.each(g.find("input, textarea, select"),function(a,b){$(this).attr("required")&&("checkbox"===$(this).attr("type")?$(this).is(":checked")?$('[data-checkboxrelative="'+$(this).attr("id")+'"]').css("display","block"):($('[data-checkboxrelative="'+$(this).attr("id")+'"]').css("display","none"),c=!1):"radio"!==$(this).attr("type")&&!$(this).parent().hasClass("valid")&&$(this).attr("required")&&(c=!1),null===$(this).val()&&(c=!1),""===$(this).val()&&(c=!1))});c?(g.find('button[type="submit"], [data-action="submit"]').removeClass("btn-disabled"),
e({form:g.attr("id"),status:"validated"})):(g.find('button[type="submit"], [data-action="submit"]').addClass("btn-disabled"),e({form:g.attr("id"),status:"invalid"}))})};this.validateEmail=function(a){return this.email_tester.test(a)?!0:!1};this.get_datas=function(){var a={};$.each($(b).find("form").serializeArray(),function(b,c){a[c.name]=c.value});$(b).find("input:checkbox, input:radio").map(function(){a[$(this).attr("name")]=$(this).is(":checked")});$.each($(b).find(".array_list_inputs"),function(b,
c){c={};$.each($(this).find("input"),function(a,b){var g=$(this).attr("name"),d=$(this).val();if("checkbox"===$(this).attr("type")||"radio"===$(this).attr("type"))d=$(this).is(":checked");c[g]=d});a[$(this).attr("data-name")]=c});return a}}
