...
validation.get("/",function(b,a,c){a.render("validation",{title:"Validation",infos:{},js:[],css:[]});a.end()}).get("/account/:email/:validation_code",function(b,a,c){Auth_model.validAccount(b,b.params,function(b){b.message=200===b.status?"F\u00e9licitation, votre compte \u00e0 bien \u00e9t\u00e9 valid\u00e9 !":"la cl\u00e9 de validation de votre compte Joyvox est p\u00e9rim\u00e9e, veuillez vous connecter pour recevoir un nouveau lien.";a.status(200).render("validation",{title:"Validation",infos:b,
