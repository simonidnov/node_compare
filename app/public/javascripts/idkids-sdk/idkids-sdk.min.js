...
window.location.pathname),a(b))},set_user:function(){this.getStore("idkids_local_user")},store:function(a,c){try{window.localStorage.setItem(a,JSON.stringify(c))}catch(b){Cookies.set(a,JSON.stringify(c))}},getStore:function(a){try{return"idkids_local_user"===a&&(this.user=JSON.parse(window.localStorage.getItem(a))),JSON.parse(window.localStorage.getItem(a))}catch(c){return"idkids_local_user"===a&&(this.user=JSON.parse(Cookies.get(a))),JSON.parse(JSON.parse(Cookies.get(a)))}},get_device_uid:function(a){$('[name="appCodeName"]').val(navigator.appCodeName);
