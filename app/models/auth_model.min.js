...
module.exports.register=function(a,b){"undefined"!==typeof a.body.data&&(a.body=a.body.data);if("undefined"===typeof a.body||"undefined"===typeof a.body.subscribe_password)return b({status:"error",message:"NO_BODY"}),!1;User.find({email:a.body.subscribe_email},function(a,c){if(!a&&0<c.length)return b({status:203,message:"SUBSCRIBE_EMAIL_EXIST",email_already_exist:c.length}),!1});var c="undefined"!==typeof app.locals&&"undefined"!==typeof app.locals.settings?app.locals.settings.host+"/public/images/assets/account.svg":
"/public/images/assets/account.svg",d=sha1(a.body.subscribe_password);db.connect(config.database.users,{useMongoClient:!0});var e=this,c={email:a.body.subscribe_email,password:d,pseudo:a.body.pseudo,avatar:c,secret:jwt.sign({pseudo:a.body.pseudo+"_"+a.body.subscribe_email},config.secrets.global.secret,{expiresIn:"2 days"}),termAccept:!0,rights:{type:"R",authorizations:["me"]}};c.token=jwt.sign({secret:c.secret,email:a.body.subscribe_email,password:a.body.subscribe_password},config.secrets.global.secret,
{expiresIn:"2 days"});c.device=[{uid:device_uid,token:c.token}];if(a.body.subscribe_newsletter){if(c.newsletter=!0,c.newsletter_services={},"undefined"!==typeof app.locals&&"undefined"!==typeof app.locals.applications)for(d=0;d<app.locals.applications.length;d++)a.body["newsletter_"+app.locals.applications[d].short_name]&&(c.newsletter_services[app.locals.applications[d].short_name]=1)}else c.newsletter=!1,c.newsletter_services={};new_user=new User(c);new_user.save(function(c,d){c?b({status:203,message:"SUBSCRIBE_EMAIL_EXIST",
err:c}):e.reset_session(a,d._id,function(a){b({status:200,user:d});Email_controller.send(null,{subject:"Bienvenue sur JOYVOX",title:"Inscription sur JOYVOX",message:'Votre inscription \u00e0 bien \u00e9t\u00e9 prise en compte, rendez-vous sur <a href="https://auth.joyvox.fr/auth">JOYVOX pour valider votre inscription.</a>',email:d.email,to:d.email},function(a){console.log(a)})})})};
module.exports.getUserInfosFromOrderController=function(a,b){User.findOne({_id:a},function(a,d){a?b({status:403,datas:{message:a}}):b({status:200,user:d})})};
