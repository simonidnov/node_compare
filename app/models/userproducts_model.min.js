...
module.exports.allreadyBuy=function(a,e,b){console.log("allreadyBuy");Userproducts.findOne({user_id:a,product_id:e},function(a,d){a?b({status:404,message:"NEVER_BUY"}):null===d?b({status:404,message:"NEVER_BUY",datas:d}):b({status:200,message:"ALREADY_BUY",datas:d})})};
