...
if("undefined"!==typeof a.auth)switch(a.auth){case "login":$("#account_selection").addClass("displaynone").removeClass("displayblock");$("#account_forms").removeClass("displaynone").addClass("displayblock");$("#login_form").css("display","block");$("#subscribe_form").css("display","none");$("#lost_form").css("display","none");$('[data-tab="login_form"]').addClass("selected");$('[data-tab="subscribe_form"]').removeClass("selected");$("#email").focus();login.form.checkInputs();"undefined"!==typeof a.email?
