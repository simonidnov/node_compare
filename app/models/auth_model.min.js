...
module.exports.update=function(a,b,c,d){console.log("////////////////// update");device_uid=a.body.device_uid;var e=this;c.updated=Date.now();"undefined"!==typeof c.birthDate&&(c.birthDate=c.birthDate);User.update({_id:b},{$set:c},function(c,f){c?d({status:401,message:"CANT_UPDATE_TOKEN",datas:c}):e.reset_session(a,b,function(){d({status:200,message:"TOKEN_UPDATED",datas:f,response_display:{title:"Mis \u00e0 jour",message:"Votre profil vien d'\u00eatre mis \u00e0 jour."}})})},!0)};
...
module.exports.check_user=function(a,b){device_uid=a.device_infos.device_uid;jwt.sign({secret:a.options.user_secret},config.secrets.global.secret,{expiresIn:"2 days"});jwt.verify(a.options.user_token,config.secrets.global.secret,function(a,b){a&&console.log({auth:!1,message:"Failed to authenticate token."});console.log("decoded :::::::: ",b)});User.find({_id:a.options.user_id,token:a.options.user_token},function(a,d){a?b({status:203,message:"UNAUTHORISED_TOKEN",datas:a}):0===d.length?b({status:203,
message:"UNAUTHORISED"}):b({status:200,message:"TOKEN_UPDATED",datas:d})})};module.exports.checking_session=function(a,b,c){var d=this;User.findOne({_id:a.query._id,token:a.query.token,secret:a.query.secret},function(b,g){b?c({status:401,code:b.code,error:b,message:b.message}):d.reset_session(a,a.query._id,c)})};
