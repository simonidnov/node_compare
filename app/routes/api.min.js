...
a))})})["delete"]("/apps",function(a,b,d){Apps_controller["delete"](a,b,function(c){b.status(c.status).send(Auth_helper.addParams(c,a))})}).get("/pages",function(a,b,d){Pages_controller.get(a,b,function(c){b.status(c.status).send(Auth_helper.addParams(c,a))})}).post("/pages",function(a,b,d){Pages_controller.create(a,b,function(c){b.status(c.status).send(Auth_helper.addParams(c,a))})}).put("/pages",function(a,b,d){Pages_controller.update(a,b,function(c){b.status(c.status).send(Auth_helper.addParams(c,
