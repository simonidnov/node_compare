...
!1;Products_controller.get(a.body.data,b,function(d){200===d.status&&Userproducts_controller.allreadyBuy(a.body.data.options.user_id,a.body.data.product_id,function(d){200===d.status?c({status:208,message:"PRODUCT_ALREADY_BUY",response_display:{title:"Coupon Code Produit d\u00e9j\u00e0 ajout\u00e9 !",message:"Vous tentez d'ajouter un produit que vous avez d\u00e9j\u00e0 achet\u00e9 !<br>rendez-vous sur votre compte pour le t\u00e9l\u00e9charger ou sur machanson.joyvox.fr/playlist pour l'\u00e9couter.",
buttons:[{"class":"btn-success",label:"MES ACHATS",href:app.locals.settings.host+"/account/orders",target:"_blank",value:"/account/orders"},{"class":"",label:"PLAYLIST",href:"/playlist",target:"_blank",value:"/playlist"}]}}):coupon_model.is_valid(a.body.data.coupon_code,a.body.data.coupon_id,function(d){200===d.status?Userproducts_controller.create({user_id:a.body.data.options.user_id,product_id:a.body.data.product_id},b,function(b){200===b.status?coupon_model.useOne({_id:a.body.data.coupon_id,user_id:a.body.data.options.user_id},
function(a){200===a.status?c({status:200,message:"PRODUCT_ADDED",response_display:{title:"Votre chanson !",message:"Votre chanson est sur votre playlist !<br>Votre code de t\u00e9l\u00e9chargement est \u00e0 pr\u00e9sent valid\u00e9 et ne peut plus \u00eatre utilis\u00e9.",buttons:[{"class":"",label:"PLAYLIST",href:"/playlist",target:"_blank",value:"/playlist"}]}}):c({status:208,message:"UNABLE_TO_USE_COUPON_CODE",response_display:{title:"ERREUR",message:"une erreur est survenur, pas d'inqui\u00e8tude, votre coupon code de t\u00e9l\u00e9chargement est toujours valide."}})}):
(b.response_display={title:"Coupon Code",message:"une erreur est survenur mais pas d'inqui\u00e8tudes !<br>votre coupon code de t\u00e9l\u00e9chargement est toujours valide, vous pouvez toujours l'utiliser."},c(b))}):c({status:208,message:"WRONG_COUPON_CODE",response_display:{title:"Coupon Code",message:"Le coupon renseign\u00e9 est invalide, veuillez en utiliser un autre.<br>Si vous n'avez jamais utilis\u00e9 ce coupon, veuillez nous contacter pour en obtenir un nouveau.",buttons:[{"class":"btn-warning",
label:"NOUS CONTACTER",href:app.locals.settings.host+"/contact",target:"_blank",value:"/account/contact"}]}})})})})};
