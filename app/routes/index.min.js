...
router.get("/:page_url",function(b,a,d){Page_controller.get(b.params,a,function(c){1===c.datas.length?a.render("page_templates/"+c.datas[0].template,{title:"Welcome",user:b.session.Auth,locale:language_helper.getlocale(b),lang:lang,page:b.params.page_name,page_datas:c.datas[0],js:["/node_modules/swiper/dist/js/swiper.min.js"],css:["/node_modules/swiper/dist/css/swiper.min.css"]}):a.render("404",{title:"404",user:b.session.Auth,locale:language_helper.getlocale(b),lang:lang,page:b.params.page_name,
page_datas:c.datas,js:["/node_modules/swiper/dist/js/swiper.min.js"],css:["/node_modules/swiper/dist/css/swiper.min.css"]});a.end()})});module.exports=router;
