...
var db=require("mongoose"),config=require("../config/config"),cc=require("coupon-code"),coupons_datas={offer:{type:"string"},label:{type:"string"},description:{type:"string"},code:{type:"string"},amount:{type:"number"},product_id:{type:"string"},parts:{type:"number","default":1},partLen:{type:"number","default":4},admin_id:{type:"string"},user_id:{type:"string"},already_used:{type:"bool","default":!1},is_valid:{type:"bool","default":!0},created:{type:"Date","default":Date.now},updated:{type:"Date",
"default":Date.now}};0===db.connection.readyState&&db.connect(config.database.users,{useMongoClient:!0});var couponsSchemas=new db.Schema(coupons_datas),Coupon=db.model("Coupons",couponsSchemas);module.exports={attributes:coupons_datas};module.exports.get=function(a,b,c){b={};"undefined"!==typeof a.params.offer&&(b.offer=a.params.offer);"undefined"!==typeof a.query.code&&(b.code=a.query.code,b.is_valid=!0,b.already_used=!1);Coupon.find(b,function(a,b){a?c({status:405,datas:a}):c({status:200,datas:b})})};
...
module.exports.create=function(a,b,c){b=a.body;delete b.options;delete b._id;delete b.user;new_coupon=new Coupon(a.body);new_coupon.save(function(a,b){a?c({status:405,message:a}):c({status:200,datas:b})})};module.exports.useOne=function(a,b){Coupon.updateOne({_id:a._id},{$set:{is_valid:!1,already_used:!0,user_id:a.user_id,updated:Date.now()}},function(a,d){a?b({status:304,message:a}):b({status:200,datas:d})})};
module.exports.updateOffer=function(a,b,c){update_datas={description:a.body.description,label:a.body.label,amount:a.body.amount,product_id:a.body.product_id,updated:Date.now()};Coupon.updateMany({offer:a.body.offer},{$set:update_datas},function(a,b){a?c({status:304,message:a}):c({status:200,datas:b})})};module.exports.update=function(a,b,c){a.body.updated=Date.now();Coupon.updateOne({_id:a.body.coupon_id},{$set:a.body},function(a,b){a?c({status:304,message:a}):c({status:200,datas:b})})};
module.exports.updateAmount=function(a,b,c){Coupon.updateMany({},{$set:{amount:499}}).exec(function(a,b){c({status:200,datas:b})})};module.exports["delete"]=function(a,b,c){b={};"undefined"!==typeof a.body.offer&&(b.offer=a.body.offer);"undefined"!==typeof a.body.coupon_id&&(b._id=a.body.coupon_id);"undefined"!==typeof a.body.code&&(b.code=a.body.code);Coupon.deleteMany(b,function(a,b){a?c({status:405,message:a}):c({status:200,pages:b})})};
module.exports.is_valid=function(a,b,c){Coupon.find({_id:b,code:a,is_valid:!0,already_used:!1},function(a,b){a?c({status:405,message:a}):1<=b.length?c({status:200,coupon:b[0]}):c({status:203,coupon:b})})};
