...
router.use(function(a,c,b){var d=(a.headers["x-forwarded-proto"]||"").toLowerCase();"https"===d?(console.log("HAS HTTPS ",d),b()):(console.log("DOESNT HAVE HTTPS ",d),console.log("req.get('host') ",a.get("host")),console.log("req.get('origin') ",a.get("origin")),-1===a.headers.host.indexOf("127.0.0.1:3000")?c.redirect("https://"+a.headers.host+a.url):b())});router.use("/admin",admin);router.use("/admin/:any",admin);router.use("/users",users);router.use("/me",me);router.use("/account",account);
