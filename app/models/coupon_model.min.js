...
module.exports.update=function(a,b,c){a.body.updated=Date.now();Coupon.updateOne({_id:a.body.coupon_id},{$set:a.body},function(a,b){a?c({status:304,message:a}):c({status:200,datas:b})})};module.exports.updateAmount=function(a,b,c){Coupon.updateMany({offer:"chansonspersonnalisees"},{$set:{amount:499}}).exec(function(a,b){c({status:200,datas:b})})};
