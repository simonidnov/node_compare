...
Auth_helper.validate_session(a,function(e){console.log("VALIDATE SESSION ",e);200===e.status?c():Auth_helper.validate_user(d,a.get("host"),function(a){200===a.status?c():b.status(a.status).send(a)})})});
