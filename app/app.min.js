...
app.use(function(a,c,b){"https"===(a.headers["x-forwarded-proto"]||"").toLowerCase()?b():-1===a.headers.host.indexOf("127.0.0.1")&&c.redirect("https://"+a.headers.host+a.url)});app.use(express["static"](path.join(__dirname,"public")));router.use("/admin",admin);router.use("/admin/:any",admin);router.use("/users",users);router.use("/me",me);router.use("/account",account);router.use("/account/:any",account);router.use("/api",api);router.use("/media",media);router.use("/gmail",gmail);
