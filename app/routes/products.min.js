...
b,c){crypto.pseudoRandomBytes(16,function(a,d){c(null,d.toString("hex")+Date.now()+"."+Mime.getExtension(b.mimetype))})}}),upload=multer({storage:storage,dest:"./uploads/",inMemory:!0,includeEmptyFields:!0});
