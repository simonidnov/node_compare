...
{product_id:$(this).attr("data-productid"),quantity:$(this).attr("data-quantity")},function(a){console.log("AJOUT AU PANIER AVEC SUCCES ? ",a)});break;case "delete_basket_product":console.log("delete basket "+$(this).attr("data-basketid")+" "+$(this).attr("data-productid"));a.api.deleting("/basket",{basket_id:$(this).attr("data-basketid"),product_id:$(this).attr("data-productid")},function(a){console.log("supprime de PANIER AVEC SUCCES ? ",a);200===a.status&&window.location.reload()});break;default:console.log("action not reconized by idkids sdk, please upgrade your sdk version")}})}};
