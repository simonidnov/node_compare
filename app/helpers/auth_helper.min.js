...
typeof a.options?c({status:203,message:"UNAUTHARISED need OPTIONS"}):"undefined"===typeof a.options.user_id?c({status:203,message:"UNAUTHARISED need valid user ID"}):"undefined"===typeof a.options.user_secret?c({status:203,message:"UNAUTHARISED need valid user secret"}):"undefined"===typeof a.options.user_token?c({status:203,message:"UNAUTHARISED need valid user token"}):(a.options.device_uid=device_uid,Auth_model.check_user(a,function(a){c(a)}))},validate_session:function(a,b){"undefined"===typeof a.session.Auth?
