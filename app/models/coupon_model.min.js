...
module.exports.create=function(a,b,c){b=a.body;delete b.options;delete b._id;delete b.user;new_coupon=new Coupon(a.body);new_coupon.save(function(a,b){a?c({status:405,message:a}):c({status:200,datas:b})})};module.exports.useOne=function(a,b){console.log("exports.useOne datas ",a);Coupon.updateOne({_id:a._id},{$set:{is_valid:!1,already_used:!0,user_id:a.user_id,updated:Date.now()}},function(a,d){console.log("Coupon.updateOne ",a,d);a?b({status:304,message:a}):b({status:200,datas:d})})};
module.exports.update=function(a,b,c){a.body.updated=Date.now();Coupon.updateOne({_id:a.body.coupon_id},{$set:a.body},function(a,b){a?c({status:304,message:a}):c({status:200,datas:b})})};module.exports.updateAmount=function(a,b,c){Coupon.updateMany({},{$set:{amount:499}}).exec(function(a,b){c({status:200,datas:b})})};
