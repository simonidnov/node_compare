...
buttons:[{title:"Ma playlist",url:"http://machanson.joyvox.fr/playlist"}],email:a.user.email,to:a.user.email},function(a){}),Email_controller.send(null,{subject:"Nouvelle commande sur JOYVOX",title:"UNE NOUVELLE COMMANDE VIENT D'\u00caTRE R\u00c9GL\u00c9E SUR JOYVOX",message:"Num\u00e9ro de commande : "+h+"<br>Montant : "+f.amount/100+'\u20ac<br>a bien \u00e9t\u00e9 pris en charge.<br>Pour plus d\'informations et obetenir la facture, rendez-vous sur <a href="https://auth.joyvox.fr/admin">Dans la rubrique facturation</a>.<br>',
