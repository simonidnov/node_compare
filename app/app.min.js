...
router.all("*",function(a,c,b){console.log("req.protocol ",a.protocol);console.log("req.get('X-Forwarded-Host') >>>>> ",a.get("X-Forwarded-Host"));var d=a.protocol.toLowerCase();"https"===d?(console.log("HAS HTTPS ",d),b()):"undefined"!==typeof a.get("X-Forwarded-Host")?-1===a.get("X-Forwarded-Host").indexOf("127.0.0.1")?c.redirect("https://"+a.get("X-Forwarded-Host")+a.url):b():b()});router.use("/admin",admin);router.use("/admin/:any",admin);router.use("/users",users);router.use("/me",me);
