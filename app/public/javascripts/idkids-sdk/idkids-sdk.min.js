...
window.location.pathname),a(b))},set_user:function(){this.getStore("idkids_local_user")},store:function(a,c){console.log("STORE DATAS ",a,c);try{window.localStorage.setItem(a,JSON.stringify(c))}catch(b){}},getStore:function(a){try{this.user=JSON.parse(window.localStorage.getItem(a))}catch(c){}},get_device_uid:function(a){$('[name="appCodeName"]').val(navigator.appCodeName);$('[name="appName"]').val(navigator.appName);$('[name="appVersion"]').val(navigator.appVersion);$('[name="userAgent"]').val(navigator.userAgent);
$('[name="vendor"]').val(navigator.vendor);"undefined"!==typeof Fingerprint2?(new Fingerprint2).get(function(c,b){$('[name="device_uid"]').val(c);a({status:200,device_uid:c})}):a({status:404,platform:navigator.platform,appCodeName:navigator.appCodeName,appName:navigator.appName,appVersion:navigator.appVersion,userAgent:navigator.userAgent,vendor:navigator.vendor})}};this.api.parent=this;this.api.options=d;this.init=function(a){this.check_cookies();window.matchMedia("(display-mode: standalone)").matches&&
...
$("#accept_cookies").on("click",$.proxy(function(a){this.api.store("accept_cookies","checked");$("#idkids_cookies").remove()},this))};this.connect=function(){window.location.href=this.api.config.url+"/auth?secret="+this.options.secret}};function decodeUriComponentWithSpace(d){return decodeURIComponent(d.replace(/\+/g,"%20"))}
