...
checking_session.get("/",function(a,b,c){"undefined"!==typeof a.query._id&&"undefined"!==typeof a.query.secret&&"undefined"!==typeof a.query.token?"undefined"===a.query._id?(b.redirect(307,"/auth"),b.end()):Auth_model.checking_session(a,a.query._id,function(a){"undefined"!==typeof a.datas&&null!==a.datas?b.redirect(307,"/account?idkids-token="+a.datas.token+"&idkids-id="+a.datas._id+"&idkids-device="+a.datas.current_device):b.redirect(307,"/auth");b.end()}):(b.render("auth/checking_session",{}),b.end())});
