...
router.use(function(a,b,c){b=(a.headers["x-forwarded-proto"]||"").toLowerCase();console.log("HAS HTTPS ",b);console.log("req.get('host') ",a.get("host"));console.log("req.get('origin') ",a.get("origin"));c()});router.get("/",function(a,b,c){b.render("offline",{title:"IDKIDS.community WELCOME"});b.end()});
