...
b,c){console.log("PUT APP :::::: ",a);Apps_controller.create(a,b,function(a){b.status(a.status).send(a)})}).put("/apps",function(a,b,c){Apps_controller.update(a,b,function(a){b.status(a.status).send(a)})})["delete"]("/apps",function(a,b,c){Apps_controller["delete"](a,b,function(a){b.status(a.status).send(a)})}).get("/pages",function(a,b,c){Pages_controller.get(a,b,function(a){b.status(a.status).send(a)})}).post("/pages",function(a,b,c){Pages_controller.create(a,b,function(a){b.status(a.status).send(a)})}).put("/pages",
function(a,b,c){Pages_controller.update(a,b,function(a){b.status(a.status).send(a)})})["delete"]("/pages",function(a,b,c){Pages_controller["delete"](a,b,function(a){b.status(a.status).send(a)})}).post("/request_validation_code",function(a,b,c){Auth_controller.request_validation_code(a,b,function(c){200===c.status?Email_controller.validate_account(a,c,function(a){b.status(a.status).send(a)}):b.status(c.status).send(c)})}).put("/change_password",function(a,b,c){b.status(200).send({title:"SERVICE CURRENTLY UNAIVALABLE"})}).get("/users/:any",
