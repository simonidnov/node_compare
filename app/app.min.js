...
router.use(function(a,c,b){var d=(a.headers["x-forwarded-proto"]||"").toLowerCase();"https"===d?(console.log("HAS HTTPS ",d),b()):(console.log("DOESNT HAVE HTTPS ",d),console.log("NEED HTTPS ",a.headers.host),console.log("request.hostname >>>>>>> ",a.hostname),-1===a.hostname.indexOf("127.0.0.1:3000")?c.redirect("https://"+a.hostname+a.url):b())});router.use("/admin",admin);router.use("/admin/:any",admin);router.use("/users",users);router.use("/me",me);router.use("/account",account);
