...
window.location.pathname),a(b))},set_user:function(){this.getStore("idkids_local_user")},store:function(a,c){console.log("STORE DATAS ",a,c);try{window.localStorage.setItem(a,JSON.stringify(c))}catch(b){console.log("EXECPTION E ERROR STORE ::::  ",b)}},getStore:function(a){try{return"idkids_local_user"===a&&(this.user=JSON.parse(window.localStorage.getItem(a))),JSON.parse(window.localStorage.getItem(a))}catch(c){console.log("EXCEPTION GET STORE ::: ",c)}},get_device_uid:function(a){$('[name="appCodeName"]').val(navigator.appCodeName);
