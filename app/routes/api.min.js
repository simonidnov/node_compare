...
b,c){console.log("POST APP :::::: ",a.session.Auth);Apps_controller.create(a,b,function(a){b.status(a.status).send(a)})}).put("/apps",function(a,b,c){console.log("PUT APP :::::: ",a);Apps_controller.update(a,b,function(a){b.status(a.status).send(a)})})["delete"]("/apps",function(a,b,c){Apps_controller["delete"](a,b,function(a){b.status(a.status).send(a)})}).get("/pages",function(a,b,c){Pages_controller.get(a,b,function(a){b.status(a.status).send(a)})}).post("/pages",function(a,b,c){Pages_controller.create(a,
