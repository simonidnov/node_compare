...
errmsg:a.errmsg}});else{var b=0;0===d.length&&c({status:200,datas:d});d.forEach(function(a){Apps_model.get(null,{_id:a.app_id},function(e){0<e.datas.length?(a.app_icon=e.datas[0].icon,a.app_label=e.datas[0].label,a.app_infos=[],b++,b===d.length&&c({status:200,datas:d})):c({status:200,datas:d})})})}})};
