...
module.exports.register=function(a,b){console.log("register ",a.body);"undefined"!==typeof a.body.data&&(a.body=a.body.data);if("undefined"===typeof a.body||"undefined"===typeof a.body.subscribe_password)return b({status:"error",message:"NO_BODY"}),!1;User.find({email:a.body.subscribe_email},function(a,c){if(!a&&0<c.length)return b({status:203,message:"SUBSCRIBE_EMAIL_EXIST",email_already_exist:c.length}),!1});var c=sha1(a.body.subscribe_password);db.connect(config.database.users,{useMongoClient:!0});
console.log("\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0");console.log("REGISTER BODY ::: ",a.body);console.log("REGISTER PASSWORD ::: ",a.body.subscribe_password);console.log("\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0\u00b0");
var d=this,c={email:a.body.subscribe_email,password:c,pseudo:a.body.pseudo,avatar:gravatar.url(a.body.subscribe_email,{s:"200",r:"pg",d:"404"},!0).replace("//","http://"),secret:jwt.sign({pseudo:a.body.pseudo+"_"+a.body.subscribe_email},config.secrets.global.secret,{expiresIn:"2 days"}),termAccept:!0,rights:{type:"R",authorizations:["me"]}};c.token=jwt.sign({secret:c.secret,email:a.body.subscribe_email,password:a.body.subscribe_password},config.secrets.global.secret,{expiresIn:"2 days"});c.device=
[{uid:device_uid,token:c.token}];if(a.body.subscribe_newsletter){if(c.newsletter=!0,c.newsletter_services={},"undefined"!==typeof app.locals&&"undefined"!==typeof app.locals.applications)for(var e=0;e<app.locals.applications.length;e++)a.body["newsletter_"+app.locals.applications[e].short_name]&&(c.newsletter_services[app.locals.applications[e].short_name]=1)}else c.newsletter=!1,c.newsletter_services={};new_user=new User(c);new_user.save(function(c,e){c?b({status:203,message:"SUBSCRIBE_EMAIL_EXIST",
err:c}):d.reset_session(a,e._id,function(a){b({status:200,user:e})})})};
module.exports.lost_password=function(a,b,c){console.log("............ lost_password ",a.body);"unefined"!==typeof a.body.data&&(a.body=a.body.data);"unefined"===typeof a.body.email&&c({status:203,message:"UNKNOW_USER_EMAIL"});var d=this;User.findOne({email:a.body.email},function(b,f){b?c({status:403,datas:{message:b}}):null===f?c({status:403,message:"UNKNOW_USER_EMAIL"}):d.getValidationCode(f._id,function(b){200===b.status?Email_controller.lost_password(a,b,function(a){c({status:a.status,response_display:{message:"REQUEST_PASSWORD_MESSAGE",
...
module.exports.check_user=function(a,b){console.log("/////////");console.log("/////////");console.log("/////////");console.log(a);console.log("/////////");console.log("/////////");console.log("/////////");jwt.verify(a.options.user_token,config.secrets.global.secret,function(c,d){if(c)console.log("JWT CANT SIGN"),b({status:203,message:"UNAUTHORISED_TOKEN",response_display:{title:"Session invalide",message:"Vous n'\u00eates plus connect\u00e9.<br>veuillez vous reconnecter."},datas:c});else{console.log("JWT SIGN OK ",
d);a.decoded=d;if("undefined"===typeof d.password||"undefined"===typeof d.email)return console.log("STAY HERE ??????????"),b({status:203,message:"UNAUTHORISED",response_display:{title:"Session invalide",message:"Vous n'\u00eates plus connect\u00e9.<br>veuillez vous reconnecter."}}),!1;User.find({email:d.email,password:sha1(d.password)},function(c,f){if(c)console.log("REQUEST ERROR ? ",c),b({status:203,message:"UNAUTHORISED_TOKEN",datas:c,response_display:{title:"Session invalide",message:"Vous n'\u00eates plus connect\u00e9.<br>veuillez vous reconnecter."}});
else if(0===f.length)console.log("NO USER FINDED ? ",f),b({status:203,message:"UNAUTHORISED",response_display:{title:"Session invalide",message:"Vous n'\u00eates plus connect\u00e9.<br>veuillez vous reconnecter."}});else{var e=jwt.sign({secret:f[0].user_secret,email:f[0].email,password:d.password},config.secrets.global.secret,{expiresIn:"2 days"});User.update({_id:f[0]._id},{$set:{updated:Date.now(),token:e}},function(c,d){c?b({status:401,message:"CANT_UPDATE_TOKEN",datas:c}):(a.updated_token=e,b({status:200,
message:"TOKEN_UPDATED",datas:f,updated_token:e}))},!0)}})}})};module.exports.checking_session=function(a,b,c){var d=this;User.findOne({_id:a.query._id,token:a.query.token,secret:a.query.secret},function(b,f){b?c({status:401,code:b.code,error:b,message:b.message}):d.reset_session(a,a.query._id,c)})};
