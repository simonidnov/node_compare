...
{product_id:$(this).attr("data-productid"),quantity:$(this).attr("data-quantity")},function(b){a.callback({status:"ADD_BASKET"})});break;case "delete_basket_product":a.api.deleting("/basket",{basket_id:$(this).attr("data-basketid"),product_id:$(this).attr("data-productid")},function(a){200===a.status&&window.location.reload()});break;default:console.log("action not reconized by idkids sdk, please upgrade your sdk version")}})};this.connect=function(){window.location.href=this.api.config.url+"/auth?secret="+
this.options.secret}};
