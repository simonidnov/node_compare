...
b.end()})}).get("/emails",function(a,b,d){Contact_controller.get(a,b,function(c){b.render("admin/emails",{title:"Admin Emails",emails:c.datas,user:a.session.Auth,locale:language_helper.getlocale(a),lang:lang,page:"emails",js:["/public/javascripts/admin/emails.js","/public/javascripts/components/formular.js","/node_modules/qrcode/build/qrcode.min.js"],css:["/public/stylesheets/admin/emails.css","/public/stylesheets/admin/dashboard.css","/public/stylesheets/components/formular.css"]});b.end()})});
