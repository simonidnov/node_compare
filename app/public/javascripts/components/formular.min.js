...
case "checkbox":this.validform()}if("undefined"!==typeof a.attr("data-regex")){if("same"===a.attr("data-regex"))return a.val()===$("#"+a.attr("data-target")).val()?(a.parent().addClass("valid"),a.parent().removeClass("invalid"),a.parent().find(".input_error").remove()):(a.parent().addClass("invalid"),a.parent().removeClass("valid"),this.check_error(a,b)),!1;(new RegExp(a.attr("data-regex").toString())).test(a.val())?(a.parent().removeClass("invalid"),a.parent().addClass("valid"),0<a.parent().find(".input_error").length&&
a.parent().find(".input_error").remove(),0<$('[data-checkinput="'+a.attr("id")+'"]').length&&$('[data-checkinput="'+a.attr("id")+'"] .check').addClass("checked")):(this.check_error(a,b),a.parent().addClass("invalid"),a.parent().removeClass("valid"));0<$('[data-checkinput="'+a.attr("id")+'"]').length&&($('[data-checkinput="'+a.attr("id")+'"] .check').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_hash').length&&-1!==a.val().indexOf("#")?$('[data-checkinput="'+a.attr("id")+
'"] .check_hash').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_hash').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').length&&-1!==a.val().indexOf("@")?$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_arobase').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_dot').length&&-1!==a.val().indexOf(".")?$('[data-checkinput="'+a.attr("id")+'"] .check_dot').addClass("checked"):
$('[data-checkinput="'+a.attr("id")+'"] .check_dot').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_length').length&&a.val().length>=a.attr("minlength")?$('[data-checkinput="'+a.attr("id")+'"] .check_length').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_length').removeClass("checked"),0<$('[data-checkinput="'+a.attr("id")+'"] .check_capital').length&&(RegExp("[A-Z]+","g").test(a.val())?$('[data-checkinput="'+a.attr("id")+'"] .check_capital').addClass("checked"):
$('[data-checkinput="'+a.attr("id")+'"] .check_capital').removeClass("checked")),0<$('[data-checkinput="'+a.attr("id")+'"] .check_number').length&&(RegExp("[0-9]+","g").test(a.val())?$('[data-checkinput="'+a.attr("id")+'"] .check_number').addClass("checked"):$('[data-checkinput="'+a.attr("id")+'"] .check_number').removeClass("checked")))}if("undefined"!==typeof a.attr("minlength")){var c=a.attr("minlength");a.val().length<c&&a.is(":required")?(a.parent().addClass("invalid"),a.parent().removeClass("valid"),
this.check_error(a,b)):(a.parent().addClass("valid"),a.parent().removeClass("invalid"),a.parent().find(".input_error").remove())}else a.parent().addClass("valid"),a.parent().removeClass("invalid");this.validform()}};this.validform=function(a){$.each($(this.target).find("form"),function(a,b){var c=!0,g=$(this);$.each(g.find("input, textarea, select"),function(a,b){$(this).attr("required")&&("checkbox"===$(this).attr("type")?$(this).is(":checked")?$('[data-checkboxrelative="'+$(this).attr("id")+'"]').css("display",
"block"):($('[data-checkboxrelative="'+$(this).attr("id")+'"]').css("display","none"),c=!1):"radio"!==$(this).attr("type")&&!$(this).parent().hasClass("valid")&&$(this).attr("required")&&(c=!1),null===$(this).val()&&(c=!1),""===$(this).val()&&(c=!1))});c?(g.find('button[type="submit"], [data-action="submit"]').removeClass("btn-disabled"),e({form:g.attr("id"),status:"validated"})):(g.find('button[type="submit"], [data-action="submit"]').addClass("btn-disabled"),e({form:g.attr("id"),status:"invalid"}))})};
this.validateEmail=function(a){return this.email_tester.test(a)?!0:!1};this.get_datas=function(){var a={};$.each($(b).find("form").serializeArray(),function(b,c){a[c.name]=c.value});$(b).find("input:checkbox, input:radio").map(function(){a[$(this).attr("name")]=$(this).is(":checked")});$.each($(b).find(".array_list_inputs"),function(b,c){c={};$.each($(this).find("input"),function(a,b){var g=$(this).attr("name"),d=$(this).val();if("checkbox"===$(this).attr("type")||"radio"===$(this).attr("type"))d=
$(this).is(":checked");c[g]=d});a[$(this).attr("data-name")]=c});return a}}
...
c=$(".calendar .wrapper.months .selected").attr("data-value"),e=$(".calendar .wrapper.years .selected").attr("data-value");30===d.days[parseInt(c)-1]?($(".calendar .wrapper.days li").eq(30).addClass("disabled"),$(".calendar .wrapper.days li").eq(29).removeClass("disabled")):29===d.days[parseInt(c)-1]?($(".calendar .wrapper.days li").eq(29).addClass("disabled"),$(".calendar .wrapper.days li").eq(30).addClass("disabled")):$(".calendar .wrapper.days li").removeClass("disabled");b.val(e+"-"+c+"-"+a);
b.blur()}}function base64ToBlob(b,e){e=e||"";for(var a=window.atob(b),d=[],c=0,f=a.length;c<f;c+=1024){for(var g=a.slice(c,c+1024),k=Array(g.length),h=0;h<g.length;h++)k[h]=g.charCodeAt(h);g=new Uint8Array(k);d.push(g)}return new Blob(d,{type:e})};
