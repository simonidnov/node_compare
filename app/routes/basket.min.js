...
message:'Vous avez d\u00e9j\u00e0 achet\u00e9 ce produit, rendez-vous sur <a href="http://machanson.joyvox.fr/playlist">votre playlist</a> pour l\'\u00e9couter !',type:"modal",motion:{color:"coral",src:app.locals.settings.host+"/public/images/assets/basket.svg"},buttons:[{"class":"btn-warning centered",label:"MON COMPTE",href:app.locals.settings.host+"/account/orders",target:"_self",value:"/account/orders"}]}},a)):d()})},function(a,c,d){Basket_controller.create(a.body,c,function(b){c.status(b.status).send(Auth_helper.addParams({status:b.status,
response_display:{title:"Ajout\u00e9",illus:{src:app.locals.settings.host+"/public/images/assets/basket.svg",color:"lightseagreen"},message:"Votre produit a bien \u00e9t\u00e9 ajout\u00e9 dans votre panier.",buttons:[{"class":"btn-success centered",label:"MON PANIER",href:app.locals.settings.host+"/account/basket",target:"_self",value:"/account/basket"}]}},a))})}).put("/",function(a,c,d){Basket_controller.update(a.body,c,function(b){c.status(b.status).send(Auth_helper.addParams({status:b.status,infos:b.datas},
a))})})["delete"]("/",function(a,c,d){Basket_controller["delete"](a,c,function(b){c.status(b.status).send(Auth_helper.addParams({status:b.status,infos:b.datas},a))})});module.exports=basket;
